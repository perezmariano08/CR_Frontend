...
const UserCategoriasExpulsados = () => {
    ...
    const { estadisticaZona, getEstadisticasZonaHandler } = useGetStatsHandler(categoriaFiltrada.id_categoria, 'Expulsados');
                ...
                <ContentUserWrapper>
                    <ContentUserTituloContainerStyled>
                        ...
                        <ContentMenuLink>
                            ...
                            <NavLink 
                                to={`/categoria/estadisticas/expulsados/${id_categoria}`}
                            >
                                Estadísticas
                            </NavLink>
                        </ContentMenuLink>
...
export default UserCategoriasExpulsados;
